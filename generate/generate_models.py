# TODO: Validate
"""Rebuilds every Meshfilm model from the responses recorded under `_files`.
...
# TODO: Validate
def generate_all(client: Meshfilm) -> None:
...
if __name__ == "__main__":
    ...
    generate_all(Meshfilm(build_client_automatically()))
