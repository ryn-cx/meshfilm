...
class ContentAdvisory(BaseModel):
    ...
    video_specific_rating_reason: str | None = Field(
        None, alias="videoSpecificRatingReason"
    )
...
class ParentShow(BaseModel):
    ...
    video_id: int | None = Field(None, alias="videoId")
    title_group_memberships: list[Any] | None = Field(
        None, alias="titleGroupMemberships"
    )
...
class UnifiedEntity(BaseModel):
    ...
    is_in_rolling_reminders_list: bool | None = Field(
        None, alias="isInRollingRemindersList"
    )
    ...
    num_seasons_label: str | None = Field(None, alias="numSeasonsLabel")
    seasons: Seasons | None = None
    most_liked_messages: list[MostLikedMessage] | None = Field(
        None, alias="mostLikedMessages"
    )
    tagline_messages: list[TaglineMessage] | None = Field(None, alias="taglineMessages")
    similars: list[Similar] | None = None
    ryan_murphy_collection_ids: list[Any] | None = Field(
        None, alias="ryanMurphyCollectionIds"
    )
    shonda_rhimes_collection_ids: list[Any] | None = Field(
        None, alias="shondaRhimesCollectionIds"
    )
    supplemental_videos_list: SupplementalVideosList | None = Field(
        None, alias="supplementalVideosList"
    )
    ...
    title_logo_unbranded: TitleLogoUnbranded | None = Field(
        None, alias="titleLogoUnbranded"
    )
...
class Data(BaseModel):
    model_config = ConfigDict(extra="ignore", defer_build=True)
    playback_entities: list[PlaybackEntity] | None = Field(
        None, alias="playbackEntities"
    )
