...
class ContentMetadata(BaseModel):
    ...
    primary_core_genre_metadata: PrimaryCoreGenreMetadata | None = Field(
        None, alias="primaryCoreGenreMetadata"
    )
...
class Data(BaseModel):
    model_config = ConfigDict(extra="ignore", defer_build=True)
    unified_entities: list[Any | UnifiedEntities] | None = Field(
        None, alias="unifiedEntities"
    )
