...
class Node(BaseModel):
    ...
    title: str | None = None
    total_display_runtime_in_sec: int | None = Field(
        None, alias="totalDisplayRuntimeInSec"
    )
    video_id: int | None = Field(None, alias="videoId")
...
class Video2(BaseModel):
    ...
    availability_start_time: AwareDatetime | None = Field(
        None, alias="availabilityStartTime"
    )
    short_synopsis: str | None = Field(None, alias="shortSynopsis")
    billboard_or_story_art1280: BillboardOrStoryArt1280 | None = Field(
        None, alias="billboardOrStoryArt1280"
    )
...
class Video1(BaseModel):
    ...
    all_tagline_messages_by_event_state: Any | None = Field(
        None, alias="allTaglineMessagesByEventState"
    )
    ...
    brand_logo_cropped48h: BrandLogoCropped48h | None = Field(
        None, alias="brandLogoCropped48h"
    )
    logo_stack_cropped350: LogoStackCropped350 | None = Field(
        None, alias="logoStackCropped350"
    )
    ...
    billboard_or_story_art960: BillboardOrStoryArt960 | None = Field(
        None, alias="billboardOrStoryArt960"
    )
    eclipse_billboard_redux1280: EclipseBillboardRedux1280 | None = Field(
        None, alias="eclipseBillboardRedux1280"
    )
    eclipse_billboard_redux1920: EclipseBillboardRedux1920 | None = Field(
        None, alias="eclipseBillboardRedux1920"
    )
    promo_video: PromoVideo | None = Field(None, alias="promoVideo")
    share_tagline_messages: list[ShareTaglineMessage] | None = Field(
        None, alias="shareTaglineMessages"
    )
    ...
    billboard_or_story_art1280: BillboardOrStoryArt12801 | None = Field(
        None, alias="billboardOrStoryArt1280"
    )
    availability_start_time: AwareDatetime | None = Field(
        None, alias="availabilityStartTime"
