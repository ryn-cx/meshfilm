...
class Video1(GAPIBaseModel):
    ...
    brand_logo_cropped48h: BrandLogoCropped48h | None = Field(..., alias='brandLogoCropped48h')
...
class Headers(GAPIBaseModel):
    ...
    x_netflix_context_app_version: str = Field(..., alias='x-netflix.context.app-version')
    x_netflix_context_locales: str = Field(..., alias='x-netflix.context.locales')
    x_netflix_context_operation_name: str = Field(..., alias='x-netflix.context.operation-name')
    x_netflix_request_attempt: str = Field(..., alias='x-netflix.request.attempt')
    x_netflix_request_client_context: str = Field(..., alias='x-netflix.request.client.context')
